  ...
  return (
    <Layouts>
      <GlobalSpacing className="flex-1 flex flex-col gap-20">
        <Stack spacing={2} direction={{ xs: "column", sm: "row" }} className="items-center justify-between">
          <TextField label="Search" variant="outlined"
            value={filter} onChange={onChangeFilter}
            className="flex-1 max-w-600 w-full bg-inputBg rounded-5"
          />

          <FormControl size="medium" className="flex-1 max-w-400 w-full bg-inputBg rounded-5">
        ...
        <ScrollWrapper id='guilds-container'>
